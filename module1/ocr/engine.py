...
class OcrEngine:
    ...
    def run(self, image: np.ndarray) -> OcrResult:
        ...
        rgb = cv2.cvtColor(working, cv2.COLOR_BGR2RGB) if working.ndim == 3 else working
        ...
        if rotation:
            ...
            lines = [
                OcrLine(
                    ...
                    bounding_box=map_bbox_to_original(line.bounding_box, rotation, original_width, original_height),
